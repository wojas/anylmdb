/* GENERATED by scripts/gen-rename.sh for LMDB stream 10 (LMDB 1.0.0).
 * Renames every extern symbol of the vendored engine so both streams
 * can live in one library. Do not edit by hand. */
#ifndef ANYLMDB_RENAME10_H
#define ANYLMDB_RENAME10_H
...
#define mdb_modload mdb10_modload
#define mdb_modsetup mdb10_modsetup
#define mdb_modunload mdb10_modunload
